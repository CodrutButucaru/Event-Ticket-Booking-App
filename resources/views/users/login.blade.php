        ...
        <div style="max-width: 400px; margin: auto; margin-top: 50px;">
            ...
            <form method="POST" action="{{ route('user.login') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="password" type="password" name="password" required autocomplete="current-password" style="width: 100%; padding: 8px; margin-bottom: 10px;">
                    @error('password')
                    <span class="error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <p style="margin-top: 10px; text-align: center;">Nu ai cont? <a href="{{ route('user.register') }}">Înregistrează-te aici</a></p>
        </div>
    </div>
@endsection
